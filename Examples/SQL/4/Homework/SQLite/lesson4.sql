...
('Develop ecommerse website from scratch', 1, 1003, datetime('now'), datetime('now', '+30 day')),
('WordPress website for our company', 1, 1002, datetime('now'), datetime('now', '+45 day')),
('Manage our company servers', 2, 1007, datetime('now'), datetime('now', '+45 day')),
('Hosting account is not working', 3, 1009, datetime('now'), datetime('now', '+7 day')),
('MySQL database from my desktop application', 4, 1010, datetime('now'), datetime('now', '+15 day')),
('Develop new WordPress plugin for my business website', 2, NULL, datetime('now'), datetime('now', '+10 day')),
('Migrate web application and database to new server', 2, NULL, datetime('now'), datetime('now', '+5 day')),
('Android Application development', 4, 1004, datetime('now'), datetime('now', '+30 day'));
